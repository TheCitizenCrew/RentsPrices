...
<p>Cette application permet de récolter et partager les prix des loyers.</p>
...
<ul>
<li><img src="https://s.yimg.com/pw/images/cc_icon_attribution.gif.v2" /> <strong>Paternité</strong>: vous devez citer l'auteur originale: The Citizen Crew Contributors.</li>
<li><img src="https://s.yimg.com/pw/images/cc_icon_sharealike.gif.v2" /> <strong>Partage selon les Conditions Initiales</strong>: vous pouvez re-distribution ces contenus, données et programme orginaux ou modifiés sous un contrat identique à celui-ci.</li>
</ul>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		<p>Le programme de cette application est partagé et protégé par
